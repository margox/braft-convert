...
class Demo extends React.Component {
  ...
  componentDidMount() {
    ...
    const htmlString = '<p style="text-indent:12em;text-align:center;">Hello <strong><span style="color:#f32784">World</span></strong>!<a href="http://www.baidu.com">baidu.com</a></p>'
